...
export const generateMockMetricsData = (timeframe) => {
  ...
  export const generateConversationPathData = () => {
  ...
  export const generateScriptSectionData = () => {
    const sections = [
      "Introduction", 
      "Needs Assessment", 
      "Value Proposition", 
  ...
  export const generateObjectionHandlingData = () => {
  ...
  export const generateDropOffPoints = () => {
    return [
  ...
  export const generateBestResponses = () => {
    return [
      { 
